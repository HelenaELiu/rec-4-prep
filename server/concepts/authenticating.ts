...
export default class AuthenticatingConcept {
  ...
  async getUserById(_id: ObjectId) {
    ...
    return { msg: "User found successfully!", user: await this.users.readOne({ _id }) };
  }
  ...
  async updateUsername(_id: ObjectId, username: string) {
    ...
    return { msg: "User updated successfully!", user: await this.users.partialUpdateOne({ _id}, {username}) };
  }
